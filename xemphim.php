...
if (isset($_POST["log_out"])) {
    ...
    session_unset();
    session_destroy();
    header('localhost/t/xemphim.php');
}
$id = $_GET['id'];
...
$sql = "select * from episodes where film_id = ". $id ." ORDER BY episodes.episode ASC";
$result = executeResult($sql);
...
if (isset($_POST["btn_login"])) {
    ...
    if ($username == "" || $password == "") { ?><script>
        ...
        if (count($result) < 1) { ?>
            ...
            <?php
            header("Location:xemphim.php?id=$id");
        } else {
...
<body>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        ...
                        <div id="id01" class="modal">
                            ...
                            <form class="modal-content animate" action="xemphim.php?id=<?php echo $id ?>" method="post">
    ...
    <footer class="container-fluid text-center">
        ...
        <body>
            ...
            <div class="support">
                <h4>Liên Hệ Hỗ Trợ <?php echo $emp ?></h4>
                <b>
